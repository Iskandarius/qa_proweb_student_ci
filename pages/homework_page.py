...
class HomeworkPage:
    def __init__(self, driver):
        ...
        self.task_btn = (By.CSS_SELECTOR, '#app > div > div.container.container_mobile > div > div > div.tab-content.group-homeworks-tab-content > div > div.lazyscroll > div > div:nth-child(2) > div.work-dropdown.homework-card_drop.grow.homework-card_drop-active > div.work-dropdown-content > div > button')
