...
class LessonsPage:
    def __init__(self, driver):
        ...
        self.last_lesson = (By.CSS_SELECTOR, '#app > div > div.container.container_mobile > div > div > div.new-lessons_content > div > div:nth-child(4) > div.flex.gap20 > div:nth-child(3) > div.lesson-card > div')
